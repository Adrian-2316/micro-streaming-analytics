...
import com.streaming.analytics.content.datapoint.infrastructure.controller.dto.output.DatapointOutputDTO;
...
public class CreateDatapointController {
  ...
  public SimpleDatapointOutputDTO create(
      ...
      throws Exception {
    Datapoint datapoint = datapointInputDTO.datapoint(new Datapoint());
    Datapoint createdDatapoint = createDatapointPort.create(datapoint);
