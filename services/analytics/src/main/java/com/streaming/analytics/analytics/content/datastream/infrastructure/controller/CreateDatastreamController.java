package com.streaming.analytics.analytics.content.datastream.infrastructure.controller;
...
import com.streaming.analytics.analytics.content.datastream.infrastructure.controller.dto.input.DatastreamInputDTO;
import com.streaming.analytics.analytics.content.datastream.infrastructure.controller.dto.output.DatastreamOutputDTO;
import com.streaming.analytics.analytics.content.datastream.infrastructure.controller.dto.output.SimpleDatastreamOutputDTO;
...
@SwaggerDefinition(tags = {
        @Tag(name = "Datastream", description = "Datastream endpoints")
})
...
public class CreateDatastreamController {
    ...
    public SimpleDatastreamOutputDTO create(
        ...
        Datastream datastream =
                datastreamInputDTO.datastream(new Datastream());
        Datastream createdDatastream =
                createDatastreamPort.create(datastream);
