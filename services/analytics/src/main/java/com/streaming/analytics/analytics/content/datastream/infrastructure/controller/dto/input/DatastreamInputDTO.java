package com.streaming.analytics.analytics.content.datastream.infrastructure.controller.dto.input;
...
public class DatastreamInputDTO {
    ...
    public Datastream datastream(Datastream datastream) {
        ...
        datastream.setDatapointList(this.datapointList.stream().map(datapointInputDTO -> datapointInputDTO.datapoint(new Datapoint())).collect(Collectors.toList()));
        return datastream;
    }
}
