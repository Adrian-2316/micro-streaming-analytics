package com.streaming.analytics.analytics.content.statistics.infrastructure.controller;


import com.streaming.analytics.analytics.content.statistics.application.port.CreateStatisticsPort;
import com.streaming.analytics.analytics.content.statistics.domain.Statistics;
import com.streaming.analytics.analytics.content.statistics.infrastructure.controller.dto.input.StatisticsInputDTO;
import com.streaming.analytics.analytics.content.statistics.infrastructure.controller.dto.output.SimpleStatisticsOutputDTO;
import com.streaming.analytics.analytics.content.statistics.infrastructure.controller.dto.output.StatisticsOutputDTO;
...
public class CreateStatisticsController {
    ...
    public SimpleStatisticsOutputDTO create(
        ...
        Statistics statistics =
                statisticsInputDTO.statistics(new Statistics());
        Statistics createdStatistics =
                createStatisticsPort.create(statistics);
